...
<template>
    <div>
        ...
        <div class="my-500">
            ...
            <es-badge class="ml-50" variant="success">
                Success
            </es-badge>

            <es-badge class="ml-50" variant="warning">
                Warning
            </es-badge>

            <es-badge class="ml-50" variant="danger">
                Danger
            </es-badge>

            <es-badge class="ml-50" variant="info">
                Info
            </es-badge>

            <es-badge class="ml-50" variant="dark">
                Dark
            </es-badge>
        </div>
