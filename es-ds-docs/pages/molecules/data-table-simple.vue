...
<template>
    <div>
        ...
        <p class="mb-500">
            ...
            Familiarity with the capabilities of the base component is <strong>strongly recommended</strong> if expanding the functionality of this table.
        </p>
        <div class="mb-500">
            <h2 class="mb-200">
                Basic version
    ...
    <div>
        ...
        <p class="mb-500">
            ...
            <nuxt-link
                ...
                target="_blank">
                Bootstrap documentation</nuxt-link>.
            Familiarity with the capabilities of the base component
            is <strong>strongly recommended</strong> if expanding the functionality of this table.
        </p>
        <div class="mb-500">
            <h2 class="mb-200">
                Basic version
