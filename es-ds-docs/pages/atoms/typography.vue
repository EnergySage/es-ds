...
const createHeadingExample = (
    ...
    const lineHeightMobilePx =
        Math.round(parseFloat(lineHeightMobileRem.replace('rem', '')) * BASE_FONT_SIZE_PX * 10) / 10;
    const lineHeightDesktopRem = desktopLineHeights[identifier];
    const lineHeightDesktopPx =
        Math.round(parseFloat(lineHeightDesktopRem.replace('rem', '')) * BASE_FONT_SIZE_PX * 10) / 10;
    ...
    <div>
        ...
        <div class="my-500">
            ...
            <ds-responsive-table class="responsive-table-typography">
                <ds-responsive-table-row
                    ...
                    <ds-responsive-table-column md="3">
                        ...
                        <template #value>
                            <p class="mb-25">
                                ...
                                <span class="d-inline-block mx-25"> / </span>
                                {{ `${example.sizeMobileRem}` }}
                            </p>
                            <p class="font-size-75 mb-0">
                                <span class="font-italic"> Line height: </span>
                    ...
                    <ds-responsive-table-column md="3">
                        <template #name> Desktop </template>
                        <template #value>
                            <p class="mb-25">
                                <span class="font-italic"> Size: </span>
                    ...
                    <ds-responsive-table-column md="3">
                        <template #name> Attributes </template>
                        <template #value>
                            <p class="mb-25">
                            ...
                            <p class="font-size-75 mb-25">
                                <span class="font-italic"> Bottom margin: </span>
                            ...
                            <p
                                ...
                                <span class="font-italic"> Letter spacing: </span>
                                {{ `${example.letterSpacingPx}px` }}
                                <span class="d-inline-block mx-25"> / </span>
                                {{ `${example.letterSpacingRem}` }}
                            </p>
                            <p class="font-size-75 mb-0">
                                <span class="font-italic"> Color: </span>
                                {{ example.color }}
                            </p>
                        </template>
                    </ds-responsive-table-column>
        ...
        <div class="my-500">
            ...
            <div class="border pb-lg-100 px-100 px-lg-200 pt-100 pt-lg-200 rounded">
                <h3 class="eyebrow mb-25">Property details</h3>
                <h4 class="h1">What is your address?</h4>
            </div>
        </div>

        <div class="my-500">
            <h2>Eyebrow as visual treatment only</h2>
            <p>
            ...
            <div class="border pb-lg-100 px-100 px-lg-200 pt-100 pt-lg-200 rounded">
                <figure>
                    ...
                    <figcaption>
                        <p class="eyebrow mb-0 text-body">Sofia</p>
                        <p>Homeowner</p>
                    </figcaption>
                </figure>
            </div>
        ...
        <div class="my-500">
            ...
            <p>Here is an example of an ordered list.</p>
            <ol>
                <li>This is the first item.</li>
                <li>This is the second item.</li>
                <li>This is the third item.</li>
            </ol>
            <p>Here is an example of an unstyled list.</p>
        ...
        <b-row class="my-500">
            <b-col>
                ...
                <p>
                    ...
                    breakpoint are also available (e.g. <code>font-size-sm-400</code>, <code>font-size-md-400</code>,
                    <code>font-size-lg-400</code>, <code>font-size-xl-400</code>, <code>font-size-xxl-400</code>).
                </p>
                <ds-responsive-table class="responsive-table-typography">
                    <ds-responsive-table-row
        ...
        <es-collapse
            ...
            <template #title>
                <h2 class="mb-0">Legacy class names</h2>
            </template>
            <p>
                The typography class names below are deprecated and have been updated to the new style that is the
                closest match. Avoid using them in new code, and refactor your existing code to remove instances of
                them. They will be removed in a future version of ESDS.
            </p>

            <div class="my-500">
                <h3>Display (deprecated)</h3>
                <ds-responsive-table class="responsive-table-typography">
                    <ds-responsive-table-row
