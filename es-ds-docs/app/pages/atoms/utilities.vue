...
<template>
    <div>
        ...
        <div class="category-list my-400">
            <div
                v-for="category in utilityClasses.categories"
                :key="category.name"
                class="category">
                <h2 class="bg-soft-blue font-size-75 mb-0 ml-n50 px-50 py-25 rounded">
                    {{ category.name }}
                </h2>
        ...
        <es-collapse>
            ...
            <div class="category-list">
                <div
                    ...
                    :key="category.name"
                    class="category">
                    <h2 class="bg-soft-blue font-size-75 mb-0 px-50 py-25 rounded">
                        {{ category.name }}
                    </h2>
                    <ul class="category-classes font-size-75 list-unstyled pl-50">
                        <li
                            v-for="classData in category.classes"
                            :key="classData.name">
                            {{ classData.name }}
