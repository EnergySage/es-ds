...
interface EsMobileNavItemInterface {
    name: string;
    href?: string;
    items?: EsMobileNavItemInterface[];
}

const items: EsMobileNavItemInterface[] = [
    {
        name: 'Home solar',
        items: [
            {
    ...
    <div>
        ...
        <div class="my-300">
            <es-mobile-nav>
                ...
                <!--<es-mobile-nav-content>
                    <es-mobile-sub-nav-item-link href="https://www.energysage.com">
                        EnergySage
                    </es-mobile-sub-nav-item-link>
                    <es-mobile-sub-nav>
                        <es-mobile-sub-nav-item value="">
                            <es-mobile-sub-nav-item-link href="https://www.energysage.com">
                                EnergySage
                            </es-mobile-sub-nav-item-link>
                        </es-mobile-sub-nav-item>
                        <es-mobile-sub-nav-item value="">
                            <es-mobile-sub-nav-item-trigger>
                                Home solar
                            </es-mobile-sub-nav-item-trigger>
                            <es-mobile-sub-nav-item-content name="">
                                <es-mobile-sub-nav-item-link href="https://www.energysage.com/solar/calculator/">
                                    Solar calculator
                                </es-mobile-sub-nav-item-link>
                            </es-mobile-sub-nav-item-content>
                        </es-mobile-sub-nav-item>
                    </es-mobile-sub-nav>
                </es-mobile-nav-content>-->
            </es-mobile-nav>
