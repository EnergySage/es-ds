export interface EsMenuBarSampleCtaInterface {
    icon?: string;
    heading: string;
    href?: string;
    subtitle?: string;
...
export interface EsMenuBarSampleItemInterface {
    cta?: EsMenuBarSampleCtaInterface;
    name: string;
    href?: string;
    items?: EsMenuBarSampleItemInterface[];
    target?: '_self' | '_blank';
}
...
export const menuBarSampleItems: EsMenuBarSampleItemInterface[] = [
    {
        name: 'Home solar',
        cta: {
