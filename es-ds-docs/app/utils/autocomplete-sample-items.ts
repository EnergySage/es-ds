...
// most topics run long on purpose, so the docs can demonstrate the suggestion
// panel growing wider than the input when suggestions need (and the viewport
// has) the room; a few stay short for contrast
export const SAMPLE_LIST_OF_SEARCH_TERMS = [
    'battery backup for whole home power outages',
    'community solar subscription with no upfront cost',
    'electric bill rate increases in new england this winter',
    'ev charger installation cost for a garage',
    'federal solar tax credit and how to claim it',
    'heat pump cost for a 2000 square foot home',
    'heat pump installation before winter rebates expire',
    'heat pump rebates and incentives by state',
    'heat pump vs central air conditioning cost comparison',
    'heat pump water heater vs tankless gas water heater',
    'heat pumps',
    'home electrification planning for an older house',
    'how much do solar panels cost in massachusetts',
    'lease vs buy solar panels pros and cons',
    'net metering',
    'solar batteries worth it during power outages',
    'solar financing options with no money down',
    'solar installers near me with good reviews',
    'solar panel cost after the federal tax credit',
    'solar panel installation cost for a 2000 square foot home',
    'solar panel installation timeline from quote to turn on',
    'solar panels',
    'solar rebates and incentives by state',
    'ten ways to save energy and lower your electric bill',
    'virtual power plant programs that pay you',
    'whole home backup power without a gas generator',
];
