...
<template>
    ...
    >
        <Column
            v-for="(col, index) of columns" :key="col?.key ? col.key : col" :field="col?.key ? col.key : col" :header="label(col)"
            :sortable="col?.sortable"
            :frozen="checkFrozenRow(index)" align-frozen="left"
            :pt="{
                sortIcon: {
                    style: 'display: none',
                },
