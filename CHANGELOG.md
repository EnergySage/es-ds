...
- Actually add Threads and Bluesky logos

## [2.3.0] - 2025-07-09

- Attempted to add Threads and Bluesky logos

## [2.2.7] - 2025-06-11

- Fix edge case with refresh not happening after previously opting in and then opting out

## [2.2.6] - 2025-06-10

- Avoid unnecessary refreshes when opting in to cookies
...
- Updated search bar behavior on `EsNavBarWithSearch`
...
- Updated `EsNavBarWithSearch` with mobile search functionality
...
[2.4.1]: https://github.com/EnergySage/es-ds-legacy/compare/v2.4.0...v2.4.1
[2.4.0]: https://github.com/EnergySage/es-ds-legacy/compare/v2.3.0...v2.4.0
[2.3.0]: https://github.com/EnergySage/es-ds-legacy/compare/v2.2.7...v2.3.0
[2.2.7]: https://github.com/EnergySage/es-ds-legacy/compare/v2.2.6...v2.2.7
[2.2.6]: https://github.com/EnergySage/es-ds-legacy/compare/v2.2.5...v2.2.6
