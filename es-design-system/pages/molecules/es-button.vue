...
export default {
    ...
    async created() {
        if (this.$prism) {
            ...
            const { default: docSource } = await import('./es-button.vue?raw');
            const { default: compSource } = await import(
                '@energysage/es-vue-base/src/lib-components/EsButton.vue?raw'
            );
            /* eslint-enable import/no-webpack-loader-syntax, import/no-self-import */

            this.docCode = this.$prism.normalizeCode(docSource);
            this.compCode = this.$prism.normalizeCode(compSource);
