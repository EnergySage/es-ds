<template>
    <svg
        ...
        <path d="m15.414 6.018-4.542 5.46L8.506 9.11a.998.998 0 0 0-1.092-.22 1.006 1.006 0 0 0-.325 1.635l3.144 3.162a1 1 0 0 0 .709.301h.05a.995.995 0 0 0 .718-.361l5.24-6.323a1.008 1.008 0 0 0-.129-1.415.996.996 0 0 0-1.407.13Z" />
    </svg>
</template>
<script>
export default {
    name: 'ChatApproveIcon',
    props: {
        /**
         * Width
         */
